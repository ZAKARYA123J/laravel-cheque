                        ...
                        @foreach ($cheques as $item)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <h4>{{ $item->carnte->Serie . $item->carnte->Dernier_Number }}</h4>
                                ...
                                <td>
                                    ...
                                    {{-- <form action="{{ route('addnewCheque.delet', $item->id) }}" method="POST">
                                        @csrf
                                        <input name="_method" type="hidden" value="DELETE">

                                        <button type="submit" class="btn btn-danger">
                                            <i class='bx bx-message-square-x bx-tada bx-rotate-270'></i>
                                        </button>
                                    ...
                                    <form action="" method="POST">
                                        ...
                                        <button type="submit" class="btn btn-success ml-2"><i class='bx bxs-file-import bx-tada' ></i>
                                        </button>
